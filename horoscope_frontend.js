window.onload = function() {
    ...
    xhr.open('GET', 'http://143.198.79.177:8000//getUsers', true);  // Replace with your actual server URL
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`http://143.198.79.177:8000//getHoroscope?year=${year}&month=${month}&day=${day}`)
